...
app.get("/addstudent", (req, res) => {
    ...
    // Sanitization XSS...
    let qry = "select * from student where regno=? or email=?";
...
app.get("/searchstudent", (req, res) => {
    ...
    let qry = "select * from student where regno=?";
...
app.get("/updatestudent", (req, res) => {
    ...
    let qry = "update student set username=?,email=?, gender=? where regno=?";
...
app.get("/removestudent", (req, res) => {
    ...
    let qry = "delete from student where regno=?";
    mysql.query(qry, [phone], (err, results) => {
        if (err) throw err
        else {
            if (results.affectedRows > 0) {
